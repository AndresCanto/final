...
<html lang="es">
  <head>
    ...
    <!-- Font Awesome 6 -->
    <script src="https://kit.fontawesome.com/7c7e7400f9.js" crossorigin="anonymous"></script>

    <!-- DataTables -->
    <link rel="stylesheet" href="https://cdn.datatables.net/1.12.0/css/jquery.dataTables.min.css">
      
    <!-- Mis estilos -->
    <link rel="stylesheet" href="/final/template/header.css">
  </head>
  <body>
    <nav class="navbar navbar-expand-sm navbar-dark bg-dark">
      <div class="container-fluid">
        <a class="navbar-brand" href="/final/home.php">Balanze</a>
